...
""" Code Snippet used ==> Lets me modify my .css file and refresh the website without having to 
 repeatedly clear the browser cache EVERYTIME! :D """
...
# Only take POST, since we only accept when user submits DELETE from MODAL
@login_required
